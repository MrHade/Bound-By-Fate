...
Character::Character(std::string m_name)
{
    ...
    m_sprite.setTextureRect(sf::IntRect(0,0,48,48));// Character is 24x31
    m_sprite.setScale(0.64,0.64);//Now the character has the same size as the tiles 32x32
